class Add_Bill_Payer{
    ...
    addemail() {
        cy.get('#email').should('be.visible').type('shahztest1@example1.com');
    }
    
    addconfirmemail() {
        cy.get('#confirmEmail').should('be.visible').type('shahztest1@example1.com');
    }
